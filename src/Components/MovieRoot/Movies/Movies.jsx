...
import { FaStar, FaPlay, FaSearch, FaSpinner, FaSadTear, FaCalendarAlt, FaFilm, FaLanguage } from 'react-icons/fa';
...
const Movies = () => {
  ...
  const filteredMovies = selectedCategory === 'All'
    ? movies
    : movies.filter(movie => movie.Details.Genre.includes(selectedCategory));
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-900 text-white">
      ...
      <div className="your-element-class flex justify-center space-x-4 mb-8 overflow-x-auto">
